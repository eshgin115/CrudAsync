...
namespace DemoApplication.Areas.Client.Controllers
{
    ...
    public class BookController : Controller
    {
        ...
        [HttpGet("GetModel/{id}", Name = "Book-GetModel")]
        public async Task<ActionResult> GetModelAsync(int id)
        {
            var book = await _dbContext.Books.Include(a=>a.Author).FirstOrDefaultAsync(b => b.Id == id);
            ...
            var model = new ModelViewModel(book!.Title, book.Author, book.Price, book.AuthorId);

            return PartialView("~/Areas/Client/Views/Shared/Partials/GetModel/_BookModalPartial.cshtml", model);
        }
    }
}
